      ...
      <ScrollView className='history' scrollY>
        ...
        {this.state.editing ?
          <View className='historyItem'> 
            <Input className='itemInput' value={this.props.title} onInput={this.setState({title: e.detail.value)}} focus></Input>
            <View className='itemEdit right' onClick={() => this.isEditing(this.props.id)}>完成</View>
          </View>
          :
          <View className='historyItem'>
            {/* 删除 */}
